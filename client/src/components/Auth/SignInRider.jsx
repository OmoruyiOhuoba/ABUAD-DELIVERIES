...
import {loginRider} from "../../actions/authActions";
...
const SignInRider = () => {
    ...
    return(
        <div>
        <Link to="/home" className="normal"><img className="centre-logo" src={Logo} alt="logo"/></Link>
        <div className ="contactBody">
            ...
            <p className="ontop-form ontop-form3">Not yet a Driver?<Link to="/signuprider" className="normal3"><span className="bluelogin"> Register</span></Link></p>
