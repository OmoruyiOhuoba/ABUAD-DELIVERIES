...
const SignUpRider = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if(isValid){
        axios.post("/api/abuaddeliveries/fakesignuprider", userinfo)
        .then((res) => {
            console.log(res.data);
            alert("Your application has been sent to our Recruitment Team.\nIf qualifies, you will be notified about the next steps via email.");
    ...
    return(
     ...
     <Link to="/"><img className="centre-logo" src={Logo} alt="logo"/></Link>
        ...
        <div className ="contactBody">
            ...
            <p className="ontop-form ontop-form3">Already a Driver?<Link to="/signinrider" className="normal3"><span className="bluelogin"> Log in</span></Link></p>
