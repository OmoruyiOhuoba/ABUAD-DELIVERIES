...
const ForgotPassword = () => {
    ...
    const handleSubmit = (event) => {
      ...
      if(isValid){ 
            ...
            const sendPostRequest = async () => {
                    try {
                        const resp = await axios.post("/api/abuaddeliveries/realforgotpasswordemail", userData);
                        console.log(resp.data);
                        alert("Please login to you email to access the reset password link"); 
            ...
            return sendPostRequest();
               ...
               /* axios.post("/api/abuaddeliveries/realforgotpasswordemail", userData)
                .then(() => {
                    alert("Please login to you email to access the reset password link"); 
                    console.log("forgot password email sent");
                }).catch((error) => {
    ...
    return(
            ...
            <p className="outskirt2">Please enter your registered email in order to receive a link to reset your password</p>
