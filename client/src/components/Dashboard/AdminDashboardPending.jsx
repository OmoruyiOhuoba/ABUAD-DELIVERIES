...
import StructureAdminPending from "./StructureAdminPending";
...
const AdminDashboardPending = () => {
    ...
    useEffect(() => {
        ...
        if (isActive){
            axios.get(`/api/abuaddeliveries/adminpending`)
            .then((res) => {
            setOrder(res.data);
    ...
    return(
        <div>
            ...
            <div>
            <p className="ontop-form ontop-form2 ontop-dash ontop-dash1"><b>Ongoing</b> Orders</p>
...
export default AdminDashboardPending;